...
export const nivaran: CaseStudy = {
  slug: "nivaran",
  heroImage: "/case-studies/nivaran/dashboard.png",
  heroCaption: "The original web dashboard with seeded grievances. The newer preparation flow focuses on PF transfers.",
