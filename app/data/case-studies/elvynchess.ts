...
export const elvynchess: CaseStudy = {
  slug: "elvynchess",
  tldr: "Elvyn Chess combines a public academy website with a coaching platform for students, coaches, and admins. The academy site explains the programs and leads into a free trial, while the web portal and Expo app organize lessons, assignments, puzzles, and teaching materials. Both app clients share Supabase and a tRPC API. The Playground lets a coach and student share a chess board, hand over control, and follow the same analysis tree during a lesson.",
  architecture: {
    intro:
