...
import { Github, Linkedin, Bot, User, QrCode, X, Link as LinkIcon, LayoutGrid, BookOpen, Home } from "lucide-react";
...
export function Navbar() {
    ...
    return (
        <>
            {/* Glass Island Navbar */}
            <nav className="fixed bottom-8 left-1/2 z-50 flex -translate-x-1/2 items-center gap-3 rounded-full border border-gray-200 dark:border-zinc-700 bg-white/70 dark:bg-zinc-900/80 px-4 py-3 shadow-sm backdrop-blur-md transition-all hover:bg-white/90 dark:hover:bg-zinc-900 sm:gap-6 sm:px-6">
                
                {/* Internal Navigation */}
                <div className="flex items-center gap-3 sm:gap-4 lg:gap-4 md:gap-4">
